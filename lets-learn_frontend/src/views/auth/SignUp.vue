<template>
    <div class="bg-gray-100 min-h-screen">
        <div class="bg-gradient-to-r from-fuchsia-400 to-pink-400 mt-2 rounded shadow-sm border border-gray-300 py-8">
            ...
            <span class="flex items-center justify-center text-pink-100 font-bold text-xl"> Sign up</span>
            <span class="flex items-center justify-center text-pink-100 text-sm">Sign up for an account</span>
